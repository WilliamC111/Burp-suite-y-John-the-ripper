...
- Aprender a utilizar herramientas profesionales como Burp Suite
- Practicar técnicas de análisis de vulnerabilidades web
- Entender cómo funcionan los ataques comunes y cómo prevenirlos
...
Esta VM servirá como sistema adicional para pruebas.
...
2. Descarga el archivo ISO

#### Configuración en VirtualBox

1. Haz clic en **Nueva** en VirtualBox

2. Configura:
   - **Nombre:** Ubuntu

3. En **Set up unattended guest OS installation:**
   - **User Name:** Tu nombre de usuario
   - **Password:** Tu contraseña
   - **Confirm Password:** Confirma la contraseña
   - **Host Name:** (Opcional, por defecto usa "ubuntu")
...
3. Haz clic en **Load** y carga un archivo de diccionario de contraseñas
   > Puedes usar `/usr/share/wordlists/rockyou.txt` en Kali
...
### VirtualBox no inicia la VM

- Verifica que la virtualización esté habilitada en la BIOS
- Revisa los logs en VirtualBox para errores específicos

### Burp no captura tráfico

- Verifica que Firefox esté configurado con el proxy correcto
- Asegúrate de que Intercept esté activado en Burp
- Limpia la caché del navegador

### No puedo conectarme a Metasploitable

- Verifica que ambas VMs estén en modo Bridged Adapter
- Usa `ifconfig` en Metasploitable para confirmar su IP
- Verifica que no haya firewall bloqueando la conexión

### Certificado SSL no funciona

- Asegúrate de haber importado correctamente el certificado CA
- Reinicia Firefox después de importar el certificado

---

## ⚠️ Advertencias Legales

> **IMPORTANTE:** Este laboratorio es únicamente para fines educativos y de aprendizaje.

### Restricciones de Uso

- ✅ **PERMITIDO:** Usar en máquinas virtuales de prueba propias
- ✅ **PERMITIDO:** Aprender técnicas de seguridad en entornos controlados
- ❌ **PROHIBIDO:** Atacar sistemas sin autorización explícita
- ❌ **PROHIBIDO:** Usar estas técnicas fuera de entornos de prueba

### Responsabilidad

El uso indebido de estas herramientas puede constituir un delito. Asegúrate siempre de:

1. Tener autorización por escrito antes de realizar cualquier prueba
2. Trabajar solo en entornos aislados y controlados
3. Respetar las leyes locales e internacionales de ciberseguridad
4. Usar el conocimiento adquirido de forma ética
